...
public class GithubOAuthProvider extends com.epam.reportportal.auth.oauth.OAuthProvider {
	...
	private final OAuthRegistrationRestrictionRepository registrationRestrictionRepository;

	public GithubOAuthProvider(GitHubUserReplicator githubReplicator, AuthConfigService authConfigService,
			OAuthRegistrationRestrictionRepository registrationRestrictionRepository) {
		super("github", BUTTON, true);
		this.githubReplicator = githubReplicator;
		this.authConfigService = authConfigService;
		this.registrationRestrictionRepository = registrationRestrictionRepository;
	}

	@Override
	public ResourceServerTokenServices getTokenServices() {
		return new GitHubTokenServices(githubReplicator,
				authConfigService.loadResourceDetails("github"),
				registrationRestrictionRepository
		);
	}
